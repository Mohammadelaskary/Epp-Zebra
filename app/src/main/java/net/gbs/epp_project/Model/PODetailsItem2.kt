...
data class PODetailsItem2 (
    ...
    @SerializedName("itemqty_received"        ) var itemqtyReceived       : Int?    = null,
    @SerializedName("itemqty_accepted"        ) var itemqtyAccepted       : Int?    = null,
    @SerializedName("itemqty_rejected"        ) var itemqtyRejected       : Int?    = null,
    @SerializedName("itemqty_delivered"       ) var itemqtyDelivered      : Int?    = null,
    @SerializedName("totalitemqtyreceived"    ) var totalitemqtyreceived  : Int?    = null,
    @SerializedName("totalitemqtyaccepted"    ) var totalitemqtyaccepted  : Int?    = null,
    @SerializedName("totalitemqtyrejected"    ) var totalitemqtyrejected  : Int?    = null,
    @SerializedName("totalitemqtydelivered"   ) var totalitemqtydelivered : Int?    = null,
