...
//    @SerializedName("moveOrder_DESCRIPTION"        ) var moveOrderDescription       : String? = null,
    ...
    override fun toString(): String {
        return moveOrderRequestNumber!!
    }
    companion object {
        fun toJson(moveOrder:MoveOrder):String {
            return Gson().toJson(moveOrder)
        }
        fun fromJson(moveOrder:String):MoveOrder {
            return Gson().fromJson(moveOrder,MoveOrder::class.java)
        }
    }
}